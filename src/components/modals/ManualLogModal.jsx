        ...
        <form id="manual-log-form" onSubmit={handleSubmit}>
          ...
          <div className="flex gap-4 mb-9">
            <div className="flex-1">
              <label htmlFor="manual-start-time" className="block text-sm text-text-secondary mb-3">Start Time</label>
            ...
            <div className="flex-1">
              <label htmlFor="manual-end-time" className="block text-sm text-text-secondary mb-3">End Time</label>
              <input type="time" id="manual-end-time" className="input-field" required value={endTime} onChange={(e) => setEndTime(e.target.value)} />
            </div>
          </div>
          <p className="text-sm text-brand-danger mb-9">Sessions must be at least 15 minutes long to count.</p>
